...
const HomePage : React.FC = () => {
    return (
        <Layout>
            ...
            <Posts>
                <PostsItem
                    img={'https://masterpiecer-images.s3.yandex.net/633ff90a78fd11ee90cb1e5d9776cfa6:upscaled'}
                    authorName={'Travis Scot'}
                    postBody={'Lorem ipsum dolor sit amet consectetur adipisicing elit. Fuga iure\n' +
                ...
                <PostsItem
                    img={'https://masterpiecer-images.s3.yandex.net/633ff90a78fd11ee90cb1e5d9776cfa6:upscaled'}
                    authorName={'Travis Scot'}
                    postBody={'Lorem ipsum dolor sit amet consectetur adipisicing elit. Officia\n' +
